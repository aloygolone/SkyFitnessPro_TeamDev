    ...
    <>
      <div className="">
        ...
        <div className="flex justify-end md:justify-center">
          <div
            className="mb-[29px] mt-[24px] cursor-pointer justify-center rounded-buttonRadius bg-mainColor px-btnX py-btnY text-center font-defaultFont text-lg/[19.8px] font-normal text-black hover:bg-mainHover md:mb-[81px] md:mt-[34px] md:flex"
